...
<form id="formBanBajio" action="<?php echo site_url("PagoBanBajio/verFormulario")?>" action2="https://multipagos.bb.com.mx/Estandar/index2.php" > 		
	...
	<div class="container" id="temp_contenido_datos">
		...
		<div id="noPrinter" class="row">
			<div class="col-lg-12">
				...
				<div class="col-lg-4 derecha hidden-print">
					<?=$boton_imprimir?>
			  	</div>
	  		</div>
		</div>	
