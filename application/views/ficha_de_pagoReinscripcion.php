...
$info=Cajas::getConcepto(75, $matricula);// 201 = Multa Reinscripcion
...
<div class="container">
	...
	<div class="row">
		...
		<table class="table table-striped table-bordered lead table-condensed table-responsive" style="font-size:100%">
			...
			<tr>
				<th>Convenio</th>
				<td class="text-center">CIE 1337548</td>
				<td class="text-center">4932</td>
			</tr>
			<tr>
				<th>Monto a pagar</th>

				 <td colspan="2" class="text-center"><?=money_format("$ %i", $total)?></td>
				 <!-- MULTA -->  
				 <?php if ($activar_multa){ ?>
			...
			<tr>
				...
				<td colspan="2" class="text-center"><?=$cadena?></td>
				<!-- MULTA -->  
				<?php if ($activar_multa){ ?>
				<td><?=$cadena_multa?></td>
				<?php } ?>
			...
			<tr>
				...
				<td colspan="2" class="text-center"><?=$fecha_limite->format("d/m/Y")?></td>
				<td></td>
			</tr>
		</table>
	</div>
